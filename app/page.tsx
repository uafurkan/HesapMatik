  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 md:py-16 overflow-hidden">
      ...
      <div className="text-center mb-16 md:mb-20 relative animate-slide-up">
        ...
        <p className="text-gray-400 font-mono max-w-2xl mx-auto mb-10 text-sm sm:text-base md:text-lg leading-relaxed px-2">
          Kira artışından net maaş hesabına, YKS netinden kıdem tazminatına kadar 54 farklı aracı ücretsiz kullanın.
        </p>
        
        <SearchBar />
        
        <div className="flex flex-wrap justify-center gap-2 sm:gap-4 mt-8 text-[10px] sm:text-xs md:text-sm font-mono text-gray-400 px-2">
          <div className="glass px-3 py-2 sm:px-5 sm:py-2.5 rounded-xl border border-white/5 flex items-center gap-1.5 sm:gap-2 shadow-lg"><span className="text-amber-500 text-base sm:text-lg">⚡</span> 54 Araç</div>
          <div className="glass px-3 py-2 sm:px-5 sm:py-2.5 rounded-xl border border-white/5 flex items-center gap-1.5 sm:gap-2 shadow-lg"><span className="text-blue-400 text-base sm:text-lg">⚖️</span> %100 Yasal</div>
          <div className="glass px-3 py-2 sm:px-5 sm:py-2.5 rounded-xl border border-white/5 flex items-center gap-1.5 sm:gap-2 shadow-lg"><span className="text-green-400 text-base sm:text-lg">💸</span> Ücretsiz</div>
        </div>
      </div>

      <div className="mt-16 md:mt-24 animate-slide-up" style={{ animationDelay: '0.1s' }}>
        <div className="flex items-center justify-between mb-6 sm:mb-8">
          <h2 className="text-2xl sm:text-3xl font-bold font-syne text-white tracking-tight">Tüm Kategoriler</h2>
        </div>
        <CategoryGrid />
      </div>

      <div className="mt-20 md:mt-32 animate-slide-up" style={{ animationDelay: '0.2s' }}>
        <h2 className="text-2xl sm:text-3xl font-bold font-syne mb-6 sm:mb-8 text-white tracking-tight">En Çok Kullanılanlar</h2>
      ...
      <div className="mt-16 md:mt-24 grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 animate-slide-up" style={{ animationDelay: '0.3s' }}>
        ...
        <div className="glass-card p-8 sm:p-10 rounded-2xl sm:rounded-3xl text-center group hover:border-amber-500/40 hover:shadow-[0_0_30px_rgba(255,179,71,0.1)] transition-all duration-300">
          ...
          <h3 className="font-bold text-xl sm:text-2xl mb-3 sm:mb-4 text-white font-syne">Hızlı & Ücretsiz</h3>
          <p className="text-xs sm:text-sm text-gray-400 font-mono leading-relaxed">Üyelik yok, bekleme yok. Hesaplamalarınızı saniyeler içinde tamamen ücretsiz yapın.</p>
        </div>
        <div className="glass-card p-8 sm:p-10 rounded-2xl sm:rounded-3xl text-center group hover:border-green-500/40 hover:shadow-[0_0_30px_rgba(0,232,135,0.1)] transition-all duration-300">
          ...
          <h3 className="font-bold text-xl sm:text-2xl mb-3 sm:mb-4 text-white font-syne">Detaylı Grafik</h3>
          <p className="text-xs sm:text-sm text-gray-400 font-mono leading-relaxed">Sonuçları sadece bir rakam olarak değil, detaylı dökümler ve interaktif grafiklerle görün.</p>
        </div>
      </div>
